...
//     const [currentSection, setCurrentSection] = useState("dashboard"); // New state variable for current section
...
//             const response = await Axios.get(`http://localhost:5000/reviews1`);
...
//                         <Link to="#" className="text-gray-900 font-medium" onClick={() => setCurrentSection("hello")}>
//                             Dashboard
//                         </Link>
//                         <Link to="#" className="text-gray-600 hover:text-gray-900" onClick={() => setCurrentSection("reports")}>
//                             Reports
//                         </Link>
...
//                             Messages
//                         </Link>
//                         <Link to="#" className="text-gray-600 hover:text-gray-900" onClick={() => setCurrentSection("hello")}>
//                             Schedule
//                         </Link>
...
//                                         // console.log(index),
//                                         <Card key={index} id={index} name={element.ngo} targetDate={element.dov} reviewContent={element.reviews} />
//                                     ))}
//                                 </div>
//                             </div>
//                         </div>
...
//                         <h1 className="text-4xl font-bold text-center text-gray-900">This is Report</h1>
//                     ):(
//                         <p></p>
//                     )
        ...
        <div className="min-h-screen bg-gray-100 flex flex-col">
            ...
            <div className="flex flex-1 overflow-hidden">
                ...
                <main className="flex-1 p-6 bg-gray-100 overflow-auto">
                    ...
                    <div className="mb-6 text-center">
                        <button
                            onClick={()=>{navigate('/review1')}}
                            className="bg-yellow-500 text-white font-semibold py-2 px-4 rounded-md shadow hover:bg-indigo-400 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 mr-4"
                        >
                            Review 1
                        </button>
                        <button
                            onClick={()=>{navigate('/review2')}}
                            className="bg-green-500 text-white font-semibold py-2 px-4 rounded-md shadow hover:bg-indigo-400 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 mr-4"
                        >
                            Review 2
                        </button>
